    ...
    \str_if_eq:VnTF \l_type {proj}
      {
        \begingroup
          \centering
          \Large \textsc{py4612}~Advanced~Logic \\
          \str_if_eq:VnTF \l_idx {1}
            {
              \LARGE Project~1:~Proofs~and~models~for~the~`$\no$'~quantifier \\ [0.3em]
            } {}
          \str_if_eq:VnTF \l_idx {2}
            { 
              \vspace{-0.3em}
              \Huge Project~2 \\ [0.1em]
            } {}
          \large \today \\ [0.4em]
          \begin{spacing}{1}
      ...
      }
      {
        \begingroup
          \centering
          \huge \textsc{py4612}~Advanced~Logic \\
          \large taught~by~Prof~Greg~Restall \\ [0.3em]
          \LARGE Exercises~Week~\uppercase\expandafter{\romannumeral\l_idx} \\ [0.4em]
          \large \today \\ [0.4em]
          \begin{spacing}{1}
          \parbox{0.53\textwidth} 
            { \normalsize
